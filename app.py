...
from emoji_writer import list_emojis, print_examples, write_emoji_word, default_emoji_params
...
def home():
    emoji_word = write_emoji_word('hola', foreground="thumbs_up", random_background=True)
...
def write_word(
    ...
    emoji_word = write_emoji_word(word, 
